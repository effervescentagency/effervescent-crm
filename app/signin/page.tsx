...
<div className="bg-brand-400 px-8 py-8 text-center">
...
<div className="text-brand-50 text-sm mt-1">Staff Dashboard</div>
</div>
...
className="w-full bg-brand-400 hover:bg-brand-500 text-white font-semibold rounded-xl py-3 transition"
>
Sign in with Google
</button>
</div>
